 ...
 *     Chuyang gao - ETL file execution code tracking
 ******************************************************************************/
...
public class ExecutorFactory implements BaseDelegate<ExecutorFactory> {
	...
	protected void postExecuteSuccess(ModuleElement moduleElement, Object result, IEolContext context) {
		try{
		      ...
		      String data = moduleElement.getRegion()+"postExecuteSuccess\n";
		        RandomAccessFile randomFile = new RandomAccessFile("F:\\ideapro\\javaio-appendfile.txt", "rw");
